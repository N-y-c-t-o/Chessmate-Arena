...
function handleSelect(){
  ...
  if(selectedValue=="Register"){
          window.location.replace("http://localhost/Chess_Ai_Project/registration.php");
  }
  if(selectedValue=="LogOut"){
      window.location.replace("http://localhost/Chess_Ai_Project/logout.php");
  }
  }
  function startGame() {
      window.location.href = "http://localhost/Chess_Ai_Project/multiplayer_mode/index.php"; // Change this to your PHP file
  }
  function PlaywithAi() {
      window.location.href = "http://localhost/Chess_Ai_Project/aimode/aimode.php"; // Change this to your PHP file
  }
  document.addEventListener("DOMContentLoaded", function() {
    fetch("https://your-news-api-endpoint.com/latest-chess-news")
        .then(response => response.json())
        .then(data => {
            const newsSection = document.getElementById("chess-news");
